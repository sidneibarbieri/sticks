# Final Review Readiness - Environment Semantics Gap
...
For this study, the essential artifact checks are:
1. rerun the measurement pipeline on the bundled ATT&CK/CAPEC/FiGHT sources,
2. regenerate the released values, figures, and traceability files,
3. verify that the reported counts still match the generated artifacts.
...
- if a private manuscript tree is present, bibliography policy and manuscript
  hygiene are enforced
- if a private manuscript tree is present, the PDF rebuild remains green

...
def main():
    ...
    try:
        ...
        print(f"\n[OK] Conversion complete! {len(os.listdir(output_dir))} files saved in '{output_dir}' directory.")
        
    except FileNotFoundError:
        print(f"[FAIL] Error: Input file '{input_json_file}' not found.")
    except json.JSONDecodeError:
        print("[FAIL] Error: Invalid JSON format in the input file.")

...
def resolve_paper_dir(env_var: str, patterns: tuple[str, ...]) -> Path:
    ...
    for root in (REPO_ROOT, PROJECT_ROOT):
        for pattern in patterns:
            ...
            if matches:
                return matches[0]
    return REPO_ROOT / patterns[0]


PAPER1_DIR = resolve_paper_dir("PAPER1_DIR", ("*Paper 1*", "*paper1*", "paper1-manuscript"))
PAPER2_DIR = resolve_paper_dir("PAPER_DIR", ("*Paper 2*", "*paper2*", "paper2-manuscript"))
